    ...
    <div class="main_content">
        <div class="flex user_info_wrap">
            ...
            <div class="user_info">
                ...
                <div class="numbers">
                    <span>公開中の投稿<span class="strong">{{$posts_number}}</span>件</span>
                    <span>お気に入り数<span class="strong">{{$user_info->follower_users_count}}</span>件</span>
                    <span>総ブックマーク数<span class="strong">{{$user_bookmarks}}</span>件</span>
                </div>
                <h4>ひとこと</h4>
